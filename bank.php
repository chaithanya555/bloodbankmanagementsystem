	...
	<section class="wthree-about py-5" id="about">
		<div class="container py-xl-5 py-lg-3">
					...
					<div class="w3pvt-webinfo_mail_grid_right">
						<form role="form" action="viewbank.php" method="POST">
    <?php
    //Include database configuration file
    include('dbConfig.php');
    //Get all country data
    $query = $db->query("SELECT DISTINCT state FROM banks");
    ...
    <div class="form-group">
        ...
        <option value="">Select state first</option>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="number" name="pincode" class="form-control" pattern="[0-9]{6}" minlength="6" maxlength="6" title="please enter 6 digit pincode." />
                                                    </div>
