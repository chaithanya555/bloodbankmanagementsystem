            ...
            <div class="container-fluid">
                <form method="post" enctype="multipart/form-data">
							<div class="form-group">
                                                            <label><b>Add State:</b></label>
                                                            <input type="text" name="t1" class="form-control"  required="required" pattern="[a-zA-Z1 _]{5,15}" title="please enter only character and numbers between 5 to 15 for state name"/>
