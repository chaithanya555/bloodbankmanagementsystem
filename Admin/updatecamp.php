            ...
            <div class="container-fluid">
                <form method="post" enctype="multipart/form-data">
                    <div class="form-group">
                        <label><b>Select camp:</b></label>
                        <select name="s3" class="form-control" required><option value="">Select</option>
...
?>
                    <div class="form-group">
                        ...
                        <input type="text" name="t3" class="form-control" value="<?php if(isset($_POST["show"])){echo $camp_title;} ?>"/ required="required" pattern="[a-zA-Z0-9]{5,40}" title="please enter only character or numbers between 5 to 40 for camp title">
                    </div>
                    <div class="form-group">
                        <label><b>Organized By:</b></label>
                        <input type="text" name="t2" class="form-control" value="<?php if(isset($_POST["show"])){echo $organized_by;} ?>" required="required" pattern="[a-zA-Z0-9]{5,45}" title="please enter only character or numbers between 5 to 45 for organizer name"/>
                    </div>
                    <div class="form-group">
                        <label><b>State:</b></label>
                        <select name="s1" class="form-control" required><option value="">Select</option>
                            <?php
$cn=makeconnection();
$s="select * from state";
	$result=mysqli_query($cn,$s);
...
?>
                    ...
                    <div class="form-group">
                        <label><b>Old Pic:</b></label>
                        <img src="pic/<?php echo @$pic; ?>" width="150px" height="100px"/>
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="t4" class="form-control"><?php if(isset($_POST["show"])){echo $detail;} ?></textarea>
                    </div>

                    <button type="submit" name="sbmt" class="btn">Update</button>
                </form>
