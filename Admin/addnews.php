            ...
            <div class="container-fluid">
                <form method="post" enctype="multipart/form-data">
                    <div class="form-group">
                        ...
                        <input type="text" name="t1" class="form-control" required="required" pattern="[a-zA-Z1 _]{5,15}" title="please enter only character or numbers between 5 to 15 for news title"/>
                                                            
                    </div>
                    <div class="form-group">
                        <label><b>Details:</b></label>
                        <textarea class="form-control" name="t2"></textarea>
                    </div>
