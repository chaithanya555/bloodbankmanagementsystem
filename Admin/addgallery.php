...
?>
                    ...
                    <div class="form-group">
                        <label><b>Pic Title:</b></label>
                        <input type="text" class="form-control" name="t3" value="<?php if(isset($_POST["show"])){echo $_POST["t3"];} ?>"/ required="required" pattern="[a-zA-Z0-9 ]{5,15}" title="please enter only character or numbers between 5 to 15 for pic title">
                    </div>
                    <div class="form-group">
