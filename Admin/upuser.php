            ...
            <div class="container-fluid">
                <form method="post" enctype="multipart/form-data">
							<div class="form-group">
                                                            <label><b>Select User Name:</b></label>
...
?>
                    ...
                    <div class="form-group">
                                                            ...
                                                            <input type="password" class="form-control"  value= "<?php  if(isset($_POST["show"])){ echo $pass ;}  ?>"  required="required" pattern="[a-zA-Z0-9]{3,10}" title="please enter only character and numbers between 3 to 10 for password" name="t2"  />
                    </div>
                    <div class="form-group">
                                                            <label><b>Confirm Password:</b></label>
                                                            <input type="password" class="form-control"  value= "<?php  if(isset($_POST["show"])){ echo $pass ;}  ?>"  required="required" pattern="[a-zA-Z0-9]{3,10}" title="please enter only character and numbers between 3 to 10 for password" name="t3"  />
                    </div>
                    <div class="form-group">
                                                            <label><b>Type of User:</b></label>
                                                            <select class="form-control" name="s1" required  ><option value="">Select</option>
